...
* into the full command used by the processor. Typically 5x32 bit words are
* used to form a 160 bit command.
* 
* 5x32 use case:
* | 32b mem_bus[4] | 32b mem_bus[3] | 32b mem_bus[2] | 32b mem_bus[1] | 32b mem_bus[0] | <---instr_ptr (indexes 160b commands)
* \------------------------------------------------------------------------------------/
*                                   |
*                              cmd_read
*/
interface cmd_mem_iface#(parameter CMD_ADDR_WIDTH=8, parameter MEM_WIDTH=32, parameter MEM_TO_CMD=5)();
