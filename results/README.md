...
| `feedback_latency_impact_16q.csv` | Fig. 10, 16-qubit panels | `evaluation/evaluate_feedback_latency.py` |
| `feedback_latency_impact_32q.csv` | Fig. 10, 32-qubit panels | `evaluation/evaluate_decoherence.py` |
| `readout_duration_teleportation_fidelity.csv` | Fig. 12 — readout duration vs. teleportation fidelity | `evaluation/evaluate_readout_duration.py` |
...
| `software_mitigation_fidelity.csv` | Fig. 11 — software mitigation fidelity | `evaluation/evaluate_software_mitigation.py` (published data: same pipeline on ibm_fez hardware) |
