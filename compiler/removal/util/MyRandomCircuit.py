...
# The original code almost entirely reused with small changes.
...
def my_random_circuit(
    ...
    # Only 1-qubit and 2-qubit gates are supported 
    all_gate_lists = [gates_1q, gates_2q]
    ...
    for layer_number in range(depth):
        ...
        # Updating the counter for 1-qubit, 2-qubit
            ...
            for gate, q_start, q_end, p_start, p_end, is_cond in zip(
                ...
                if is_cond:
                    ...
                    if num_meas == 1:
                        ...
                        for bit in bits[1:]:
                            # Optional: randomly negate the current bit
                            if rng.random() < 0.2:
...
# The following function is not needed but it is kept for reference
