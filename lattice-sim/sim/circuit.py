...
# Will perform lattice surgery and measure the X and Z observables of the merged patch
...
if __name__ == "__main__":
    ...
    e, _ = sim.get_error_rate(ckt=sim.ckt, num_shots=10_000_000)
    # print(new_ckt)
    # print(sim.skew_map)
